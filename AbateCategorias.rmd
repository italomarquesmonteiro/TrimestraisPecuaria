...
part_ufs_abt_br <- test1 |>
    ggplot(aes(x = percent, y = reorder(uf, percent), fill = color)) +
        ...
        theme_void() +
        labs(
            title = "Participação no abate bovino [Bos taurus] no Brasil",
...
part_ufs_abt_br
#ggsave("Downloads/part_ufs_abt_br.png",plot = part_ufs_abt_br, dpi = 600)
```
...
perc_abate_vaca <- prop_vaca_cor |>
    ggplot(aes(x = perc, y = reorder(uf, perc), fill = color)) +
        ...
        theme_void() +
        labs(
            title = "Participação de vacas no abate",
            subtitle = "2º trimestre de 2023",
            caption = "by Ítalo Monteiro
        Fonte: IBGE [2º Trimestre(2023)]"
        ) +
...
perc_abate_vaca
#ggsave("Downloads/perc_abate_boi.png",plot = perc_abate_boi, dpi = 600)
```
...
perc_abt_boi <- prop_boi_cor |>
    ggplot(aes(x = perc_boi, y = reorder(uf, perc_boi), fill = color)) +
        ...
        theme_void() +
        labs(
            title = "Participação de bois abate",
            subtitle = "2º trimestre de 2023",
            caption = "by Ítalo Monteiro
        Fonte: IBGE [2º Trimestre(2023)]"
        ) +
...
perc_abt_boi
#ggsave("Downloads/perc_abt_boi.png",plot = perc_abt_boi, dpi = 600)
```
...
perc_abt_novilha <- prop_novilha_cor |>
    ggplot(aes(x = perc_novilha, y = reorder(uf, perc_novilha), fill = color)) +
        ...
        theme_void() +
        labs(
            title = "Participação de novilhas no abate",
            subtitle = "2º trimestre de 2023",
            caption = "by Ítalo Monteiro
        Fonte: IBGE [2º Trimestre(2023)]"
        ) +
...
perc_abt_novilha
#ggsave("Downloads/perc_abt_novilha.png",plot = perc_abt_novilha, dpi = 600)
```
...
perc_abt_novilho <- prop_novilho_cor |>
    ggplot(aes(x = perc_novilho, y = reorder(uf, perc_novilho), fill = color)) +
        ...
        theme_void() +
        labs(
            title = "Participação de novilhos no abate",
            subtitle = "2º trimestre de 2023",
            caption = "by Ítalo Monteiro
        Fonte: IBGE [2º Trimestre(2023)]"
        ) +
...
perc_abt_novilho
#ggsave("Downloads/perc_abt_novilho.png",plot = perc_abt_novilho, dpi = 600)
```
...
mapa_abt_novilho
ggsave("Downloads/mapa_abt_novilho.svg",plot = mapa_abt_novilho, dpi = 600)
```
