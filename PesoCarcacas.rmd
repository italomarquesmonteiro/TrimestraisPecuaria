...
carcaca_2tri_2023 <- abate |>
  ...
  scale_fill_manual(values = c(high = "#E46726", default = "grey45")) +
                ...
                labs(title = "Abate de bovinos no Brasil (Peso da carcaça)",
  ...
  guides(fill = FALSE) +
  annotate(
    "text", label = "Média do peso das carcaças do período",
...
```{r}
ggsave("c:/Users/italo/OneDrive/Área de Trabalho/VsCode/ibge/carcaca_2tri_2023.png",
